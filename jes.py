...
sim = Sim(_c_count=int(c_input), _stabilization_time=100, _trial_time=300,
_beat_time=20, _beat_fade_time=5, _c_dim=[4,4],
_beats_per_cycle=4, _node_coor_count=4, # x_position, y_position, x_velocity, y_velocity
...
_mutation_rate=0.3, _big_mutation_rate=0.05,
